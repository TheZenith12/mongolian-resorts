          ...
          <div className="bg-white rounded-2xl border border-gray-100 p-6">
            ...
            <div className="grid grid-cols-1 gap-4">
              ...
              <div>
                ...
                <input value={form.short_desc} onChange={e => set('short_desc', e.target.value)} className="input-field" />
              </div>
              <div>
              ...
              <div>
                <label className="block text-sm font-medium text-forest-700 mb-1.5">
                  Үндсэн үнэ (₮/шөнө)
                  {type === 'resort' && <span className="text-forest-400 text-xs ml-1">— өрөө нэмэхгүй бол</span>}
                </label>
