...
export default function PlaceForm({
  ...
  const [type, setType] = useState<"resort" | "nature">(
    place?.type ?? "resort",
  );
  ...
  const tabs = [
    ...
    ...(mode === "edit" && type === "resort"
      ? [{ id: "rooms", label: "🛏 Өрөөнүүд" }]
      : []),
              ...
              {(
                [
                  {
                    ...
                    icon: Building2,
                    desc: "Зочид буудал, бааз, кемп",
                  },
                  {
                    value: "nature",
                    label: "Байгалийн газар",
                    icon: Leaf,
                    desc: "Уул, нуур, хавцал",
                  },
                ] as const
              ).map((t) => {
                const Icon = t.icon;
                return (
                  ...
                  >
                    ...
                    <div>
                      <div className="font-medium text-forest-900 text-sm">
                        {t.label}
                      </div>
            ...
            <div className="grid grid-cols-1 gap-4">
              ...
              <div>
                ...
                <input
                  ...
                  className="input-field"
                  placeholder="Картад харагдах тайлбар"
                />
              </div>
              <div>
                <label className="block text-sm font-medium text-forest-700 mb-1.5">
          ...
          <div className="bg-white rounded-2xl border border-gray-100 p-6">
            ...
            <div className="space-y-4">
              {[
                {
                  label: "Нийтлэх",
                  desc: "Хэрэглэгчдэд харагдана",
                  value: isPublished,
                  set: setIsPublished,
                },
                {
                  label: "Онцлох",
                  desc: "Нүүр хуудсанд онцлох",
                  value: isFeatured,
                  set: setIsFeatured,
                },
              ].map((opt) => (
                ...
                >
                  ...
                  >
                    <div
                      className={`absolute top-0.5 w-5 h-5 bg-white rounded-full shadow transition-transform ${opt.value ? "translate-x-6" : "translate-x-0.5"}`}
                    />
                  </div>
                  <div>
          ...
          <div className="flex gap-3 justify-end">
            ...
            <button type="submit" disabled={loading} className="btn-primary">
              {loading ? (
                ...
                <>
                  <Save size={16} />{" "}
                  {mode === "create" ? "Газар нэмэх" : "Хадгалах"}
                </>
              )}
            </button>
          </div>
